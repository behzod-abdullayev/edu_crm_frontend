  ...
  return (
    <Tooltip.Provider>
      <motion.aside
        ...
        aria-expanded={!collapsed}
        // Hidden on mobile (< 640px), shown on tablet/desktop (≥ 640px)
        className="hidden sm:flex flex-col h-screen sticky top-0 overflow-hidden bg-[var(--bg-sidebar)] border-r border-white/5 relative shrink-0"
