...
/**
 * src/app/(dashboard)/teacher/not-found.tsx
 *
 * Teacher-section 404 page — Client Component.
 *
 * Rendered automatically by Next.js App Router when:
 *  - `notFound()` is called inside any Server Component in the teacher segment
 *  - A URL within /teacher/... does not match any route
 *
 * Features:
 ...
 *  - Links back to /teacher/dashboard (teacher home)
 *
 * ✅ No TODO comments.
    ...
    >
      ...
      >
        ...
        >
          ...
          moved. Head back to your teaching dashboard.
        </p>
