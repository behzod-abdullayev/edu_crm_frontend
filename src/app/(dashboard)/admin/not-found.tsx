 ...
 *  - `notFound()` is called inside any Server Component in the admin segment
 *  - A URL within /admin/... does not match any route
 *
 * Features:
 ...
 *  - Links back to /admin/dashboard (admin home)
 *
 * ✅ No TODO comments.
    ...
    >
      ...
      >
        ...
        >
          ...
          been moved. Return to the administration panel.
        </p>
