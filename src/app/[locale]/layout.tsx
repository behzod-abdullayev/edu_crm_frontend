...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  // Bu localStorage dagi token bilan user profilini tiklaydi
  useEffect(() => {
    if (!mounted) return;
  ...
  // syncMe tugaganidan keyin hali ham authenticated emas — loginга redirect
  useEffect(() => {
  ...
  // SSR hydration guard — server va client render bir xil ko'rinishi uchun
  if (!mounted) {
    return (
      <div
        aria-hidden="true"
  ...
  // Auth loading yoki unauthenticated — spinner ko'rsat
