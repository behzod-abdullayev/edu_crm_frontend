      ...
      {user && (
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <span
              className="inline-flex items-center gap-1.5 mt-2 px-2.5 py-0.5 rounded-full text-xs font-semibold"
              style={{
        ...
        {TABS.map(({ id, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.span
                  layoutId="owner-profile-tab-indicator"
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === 'password' && (
          <motion.div
            ...
            exit="exit"
          >
            <ChangePasswordForm userId={user?.id ?? ''} role="owner" />
          </motion.div>
        )}
      </AnimatePresence>
    </motion.div>
