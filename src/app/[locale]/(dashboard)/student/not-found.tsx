...
/**
 * src/app/[locale]/(dashboard)/student/not-found.tsx
 *
 * Student-section 404 page — Client Component.
 *
 * Rendered by Next.js when `notFound()` is called inside any Server Component
 * under src/app/[locale]/(dashboard)/student/**, OR when a user navigates to
 * a URL that starts with /[locale]/student/... but does not match any route
 ...
 *    All text is tailored to the student role; the primary CTA leads directly
 *    to the student dashboard (/[locale]/student/dashboard) rather than bare /.
 *
...
> = {
  uz: {
    ...
    body: "Siz qidirgan o'quv sahifasi mavjud emas yoki ko'chirilgan. Dashboard'ga qaytib, to'g'ri bo'limni toping.",
    toDashboard: 'Dashboard\'ga qaytish',
    goBack: 'Orqaga',
    errorBadge: '404 — Sahifa topilmadi',
    goBackAriaLabel: 'Oldingi sahifaga qaytish',
    hint: "Student bo'limi sahifasi",
  },
  en: {
    heading: 'Page Not Found',
    body: "The student page you're looking for doesn't exist or has been moved. Head back to your dashboard to find what you need.",
    toDashboard: 'Back to Dashboard',
    goBack: 'Go Back',
    errorBadge: '404 — Not Found',
    goBackAriaLabel: 'Go back to the previous page',
    hint: 'Student section page',
  },
  ru: {
    heading: 'Страница не найдена',
    body: 'Страница студента, которую вы ищете, не существует или была перемещена. Вернитесь на панель управления.',
    toDashboard: 'Вернуться на панель',
    goBack: 'Назад',
    errorBadge: '404 — Не найдено',
    goBackAriaLabel: 'Перейти на предыдущую страницу',
    hint: 'Страница раздела студента',
  },
};
...
export default function StudentNotFound() {
  ...
  const dashboardHref = `/${locale}/student/dashboard`;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <BookOpen size={11} aria-hidden="true" strokeWidth={2.5} />
            {t.hint}
          </span>
        ...
        >
          {/* Primary: back to student dashboard */}
          <motion.div
        ...
        {process.env.NODE_ENV === 'development' && (
          ...
          >
            locale: {locale} · section: student · href: {dashboardHref}
          </p>
        )}
      </motion.div>
    </div>
